...
export function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      role: 'model', 
      content: "Hi! I'm Oreo, your AI Tax Assistant. How can I help you with your Tax queries today?"
    }
  ]);
          ...
          >
            ...
            <div className="bg-gradient-to-r from-green-600 to-teal-500 p-4 flex items-center justify-between text-white shadow-md z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-lg leading-tight">Oreo</h3>
              ...
              {isLoading && (
                <div className="flex gap-3 max-w-[85%]">
                  ...
                  <div className="p-4 rounded-2xl bg-white border border-gray-100 shadow-sm rounded-tl-none flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-500 font-medium">Oreo is typing...</span>
                  </div>
                </div>
              )}
            ...
            <div className="p-4 bg-white border-t border-gray-100">
              ...
              <p className="text-[10px] text-center text-gray-400 mt-3 font-medium">
                Oreo can make mistakes. Verify critical tax advice.
              </p>
            </div>
          </motion.div>
        )}

  ...
  return (
    <section className="relative overflow-hidden pt-24 pb-32 bg-indigo-950 text-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        {user && (
          <div className="text-left mb-16 pt-4 animate-in fade-in slide-in-from-top-4 duration-700">
            <h2 className="text-3xl font-bold text-teal-400 tracking-tight">
              Hi, {user.name?.split(" ")[0] || "there"}
            </h2>
            <p className="text-indigo-200 mt-1 font-light text-lg">
              Welcome back to A.R. Wealth & Tax Co.
            </p>
          </div>
        )}
        ...
        <div className="text-center flex flex-col items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-indigo-200 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
              Whether you’re a freelancer, startup founder, or enterprise
              leader—our end-to-end tax and compliance solutions help you scale
              confidently while we handle the complexities.
            </p>

  ...
  const plans = [
    {
      ...
      period: "/ year",
      description:
        "Perfect for freelancers and early-stage startups with straightforward income.",
      features: [
    ...
    },
    {
      ...
      period: "/ year",
      description:
        "For established businesses managing multiple revenue streams and complex compliance.",
      features: [
    ...
    },
    {
      ...
      period: "/ one-time",
      description:
        "Required for growing enterprises crossing revenue thresholds or handling overseas clients.",
      features: [
        "GST Registration",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            No hidden fees. Pick the package that aligns with your business
            growth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
          {plans.map((plan, i) => (
            ...
            >
              ...
              <p className="text-gray-500 mb-6 text-sm min-h-[40px]">
                {plan.description}
              </p>
                  ...
                  <li key={idx} className="flex items-start gap-3">
                    <Check
                      className={`w-5 h-5 flex-shrink-0 mt-0.5 ${
                        plan.popular ? "text-teal-500" : "text-indigo-500"
                      }`}
                    />

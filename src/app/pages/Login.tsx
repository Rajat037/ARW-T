...
export function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus('success');
      // Store token (in a real app, use Context/Cookies)
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 text-center text-sm font-medium text-gray-600">
              ...
              <Link to="/signup" className="text-indigo-600 hover:text-indigo-500 px-1 py-1 transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-indigo-600 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform">
                Sign up instead
              </Link>
            </div>
          </div>
